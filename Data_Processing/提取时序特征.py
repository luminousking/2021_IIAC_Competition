...
############################### 测试集画图 ################################
df6 = pd.read_excel(r'C:\Users\Luminous Isaac\Documents\GitHub\2021_IIAC_Competition\Data_Processing\Related_Data\test_numbdata.xlsx')
df5 = pd.read_excel(r'C:\Users\Luminous Isaac\Documents\GitHub\2021_IIAC_Competition\Data_Processing\Related_Data\test_tsdata_equal.xlsx')
grouped = df5.groupby('ID')
a = 0

for i in range(0,70):
    dfx = grouped.get_group(df6['工件编号'][i]) 
